    ...
    <div className="navbar bg-white shadow-sm px-4 md:px-6 lg:px-8 py-4">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu-sm dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow items-center gap-6 text-gray-700"
          >
            <li>
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu-horizontal px-1 text-base items-center gap-6 text-gray-700">
          <li>
            <NavLink to="/available_studios">Available Studios</NavLink>
          </li>
          <li>
