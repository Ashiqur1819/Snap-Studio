    ...
    return (
      <div className="px-4 md:px-6 lg:px-8 mt-12">
        ...
        <p className="max-w-3xl mx-auto text-center text-gray-600">
          A record of all past reservations made by a user, including details
          like dates, locations, services, events, and payment information,
          helping users track past and manage future bookings.
        </p>
